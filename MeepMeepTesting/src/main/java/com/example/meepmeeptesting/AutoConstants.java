...
public class AutoConstants {
    ...
    public static final Pose2d RED_RIGHT_LEFT_PUSH = new Pose2d(1,-35,Math.toRadians(180));
    public static final Pose2d RED_RIGHT_LEFT_PLACE = new Pose2d(1,-37,Math.toRadians(180));
